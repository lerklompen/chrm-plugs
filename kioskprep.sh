...
#sh -c 'echo "google-chrome-stable" >> /home/kiosk/.xsession'
line="sed -i 's/\"exited_cleanly\": false/\"exited_cleanly\": true/'"
echo $line >> /home/kiosk/.xsession
sh -c 'echo "~/.config/google-chrome/Default/Preferences" >> /home/kiosk/.xsession'
sh -c 'echo "xsetroot -cursor_name left_ptr" >> /home/kiosk/.xsession'
...
unlock2="sed -i 's/xmodmap -e \"keycode 67 = 0×0000\"/#xmodmap -e \"keycode 67 = 0×0000\"/' .xsession"
unlock3="sed -i 's/google-chrome --start-maximized --incognito;/google-chrome;/ .xsession"
...
lock2="sed -i 's/#xmodmap -e \"keycode 67 = 0×0000\"/xmodmap -e \"keycode 67 = 0×0000\"/' .xsession"
lock3="sed -i 's/google-chrome;/google-chrome --start-maximized --incognito;/ .xsession"
echo $lock1 >> lock.sh
echo $lock2 >> lock.sh
echo $lock3 >> lock.sh
...
sh -c 'echo "NOW=$(date +’%Y-%m-%d-%H-%M’)" >> copysettings.sh'
